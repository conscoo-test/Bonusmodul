permissionset 5266051 "lbtbn Bonus"
{
    ...
    Permissions = table "lbtbn Bonus Contract" = X,
        ...
        table "lbtbn Bonus Item" = X,
        tabledata "lbtbn Bonus Item" = RIMD,
        ...
        codeunit "lbtbn CheckItem Meth" = X,
        ...
        codeunit "lbtbn Sales Invoice Line" = X,
        codeunit "lbtbn Sales Cr.Line" = X,
        codeunit "lbtbn Fixed Amount" = X,
